...
export function Login() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    try {
      ...
      // Call mock or real API. If API is down, fallback to mock successful login for demo
      let token = 'mock_jwt_token_12345';
      let user = { id: '1', name: 'Demo User', email: data.email, role: 'admin' };
      ...
      try {
        ...
        // Note: in a real production app without mock fallback, we would do:
