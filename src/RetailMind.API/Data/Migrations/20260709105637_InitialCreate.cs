        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    customer_id = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    hours_worked = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    reorder_quantity = table.Column<int>(type: "integer", nullable: false, defaultValue: 50),
                    warehouse_location = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    last_stock_check = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    is_deleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "ix_inventory_stock_levels",
                table: "inventory",
                columns: new[] { "quantity_on_hand", "reorder_level" });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_products_category_deleted",
                table: "products",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_work_logs_employee_id_date",
                table: "work_logs",
